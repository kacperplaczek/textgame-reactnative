export const translations = {
    pl: {
        ...
        pytanieOPowody00001: 'Masz pojęcie na co się w ogóle piszesz? Mało kto wraca.',
        odpowiedzPowod00001: 'Mam swoje powody...',
        odpowiedzPowod00002: 'Nie twój interest...',
        przejscieDoMisjiPowody00001: 'No dobrze. Przejdźmy do procedury rekrutacyjnej... Która to będzie Twoja misja?',
        ...
        przejscie_do_misji_nie_interes: 'Masz racje. Już więcej nie zapytam. Przejdźmy do procedury rekrutacyjnej... Która to będzie misja?',
        pierwsza_misja: 'Ok. Czyli zaczynamy wszystko od początku. Wolisz lot załogowy czy pojedynczy?',
        klamstwo_trzecia_misja: 'Dziwne. Nie figurujesz w mojej bazie danych. Nieważne, musimy zacząć od początku. Wolisz lot załogowy czy pojedynczy?',
        zalogowy: 'Znajdziemy Ci ciekawą załogę... Jaki statek preferujesz?',
        pojedynczy: 'Nie widzę przeszkód... Jaki statek preferujesz?',
        wybor_zaopatrzenia: 'Przekonamy się, ile masz szczęścia... Wybierz dodatkowe zaopatrzenie.',
        pytanie_o_zdrowie: 'Czy miałeś/aś stwierdzone zaburzenia wpływające na misję?',
        potwierdzenie_formularza: 'Potwierdź wysłanie formularza...',
        rozpatrzenie_wynik: 'Twoje zgłoszenie zostało rozpatrzone pozytywnie. Termin startu: NIEZWŁOCZNY',

        // Scenariusz - akt2 (akt-1.tsx)
        rozpoczecieAktu2_pan: 'Wcześniejszy akt został zakończony a ty właśnie rozpocząłeś akt drugi lecimy!',
        rozpoczecieAktu2_pani: 'Wcześniejszy akt został zakończony a ty właśnie rozpocząłaś akt drugi lecimy!',
    ...
    en: {
        ...
        przejscie_do_misji_nie_interes: 'You’re right. I won’t ask again. Let’s move on to the recruitment procedure... Which mission will it be?',
        pierwsza_misja: 'Ok. So we’re starting everything from scratch. Do you prefer a crewed flight or a solo one?',
        klamstwo_trzecia_misja: 'Strange. You’re not in my database. Never mind, we need to start from the beginning. Do you prefer a crewed flight or a solo one?',
        zalogowy: 'We’ll find you an interesting crew... Which spacecraft do you prefer?',
        pojedynczy: 'I see no objections... Which spacecraft do you prefer?',
        wybor_zaopatrzenia: 'Let’s see how lucky you are... Choose additional supplies.',
        pytanie_o_zdrowie: 'Have you been diagnosed with any conditions that could affect the mission?',
        potwierdzenie_formularza: 'Confirm the submission of the form...',
        rozpatrzenie_wynik: 'Your application has been approved. Launch date: IMMEDIATE',
