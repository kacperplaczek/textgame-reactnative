...
export const getScenes = (
  ...
  akt3_hibernacja_start: {
    ...
    notifyTime: 300,
    notification: true,
    notificationTitle: translations.scen3notification1title,
    notificationDesc: translations.scen3notification1desc,
  ...
  akt3_statek_stabilny: {
    ...
    notifyTime: 300,
    notification: true,
    notificationTitle: translations.scen3notification2title,
    notificationDesc: translations.scen3notification2desc,
