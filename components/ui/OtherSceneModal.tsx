...
import { otherScenesMap } from '@/lib/screens/OtherScenes';
...
const OtherSceneModal: React.FC<OtherSceneModalProps> = ({ visible, sceneKey, onClose }) => {
    if (!sceneKey) return null;

    const sceneData = otherScenesMap[sceneKey] || { title: 'Nieznana scena', description: 'Kliknij, aby kontynuować' };
